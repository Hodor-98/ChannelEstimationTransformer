...
cdl = CDL(cdl_model, delay_spread, carrier_frequency, ut_array, bs_array, direction, min_speed=speed, max_speed=speed+1)
print(rg.bandwidth)
...
scio.savemat("/home/bhodes/sionna/transformer_code_final/prediciton_code/CDL-B/test/CDL_B_v31_1.mat",data_dict)