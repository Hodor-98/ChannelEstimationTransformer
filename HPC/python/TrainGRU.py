...
model_dict_name  = f"TrainedTransformers/{gru.__class__.__name__}_{channel_model}_enc{enc_in}_hs{hs}_hl{hl}_seq{seq_len}_label{label_len}_best_model_params_V{speed}_{direction}.pt"
