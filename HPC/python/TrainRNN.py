...
model_dict_name  = f"TrainedTransformers/{rnn.__class__.__name__}_enc{enc_in}_hs{hs}_hl{hl}_seq{seq_len}_label{label_len}_best_model_params_V{speed}_{direction}.pt"
